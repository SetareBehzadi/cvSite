...
if (typeof exports == "object") {
  module.exports = require("resources/assets/admin/js/plugin/moments/moment-jalaali");
} else if (typeof define == "function" && define.amd) {
  define([], function(){ return require("resources/assets/admin/js/plugin/moments/moment-jalaali"); });
} else {
  this["moment"] = require("resources/assets/admin/js/plugin/moments/moment-jalaali");
}
})();
