                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div style="padding-top: 3%" class="col-sm-12">
                                <form role="form" id="form" method="post" action="{{route('password')}}" class="form-horizontal">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6"><input type="password" name="presentPassword" id="presentPassword" value=""
